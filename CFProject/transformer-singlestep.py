...
def get_data():
    ...
    series = read_csv(r'C:\Users\SimCCAD\Desktop\daily-min-temperatures.csv', header=0, index_col=0, parse_dates=True, squeeze=True)
    ...
    sampels = int(len(series) * train_size)
...
def plot_and_loss(eval_model, data_source, epoch):
    ...
    pyplot.savefig(r'C:\Users\SimCCAD\Desktop\daily-min-temperatures\graph\transformer-epoch%d.png' % epoch)
    pyplot.close()
    return total_loss / i
...
def predict_future(eval_model, data_source, steps):
    ...
    pyplot.grid(True, which='both')
    pyplot.axhline(y=0, color='k')
    pyplot.savefig(r'C:\Users\SimCCAD\Desktop\daily-min-temperatures\graph\transformer-future%d.png' % steps)
    pyplot.show()
    pyplot.close()
